...
export default function Hero() {
  ...
  // useState → show or hide discount section
  const [showDiscount, setShowDiscount] = useState(true);

  // useRef → reference to section
  ...
  return (
    <section ref={heroRef} className="bg-gray-100 py-10 px-6">
      <div className="max-w-7xl mx-auto grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 bg-[#a7e3c3] rounded-3xl p-10 relative overflow-hidden flex items-center">
          ...
          <div className="z-10 max-w-lg">
            ...
            <button
              onClick={scrollHero}
              className="mt-8 bg-[#1f2a44] text-white px-8 py-3 rounded-xl font-medium hover:bg-[#141c2f] transition"
            >
              LEARN MORE
            </button>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-[#efc89a] rounded-3xl p-8 flex justify-between items-center">
            <div>
          ...
          {/* useState Example */}
          {showDiscount && (
            <div className="bg-[#9fb5d1] rounded-3xl p-8 flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-semibold text-gray-800">
                  20% discounts
                </h2>
